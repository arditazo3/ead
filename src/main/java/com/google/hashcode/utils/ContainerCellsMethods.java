...
public abstract class ContainerCellsMethods {
    private static final Logger LOGGER = LoggerFactory.getLogger(ContainerCellsMethods.class);

    private ContainerCellsMethods() {
    }
     ...
     */
    public static Map<ContainCells, List<Step>> getAvailableSteps(ObjectLogic pizza, List<ContainCells> startPositions, List<ContainCells> output) {
        Map<ContainCells, List<Step>> groupedByAStartPositionSteps = new HashMap<>();
        Iterator iterator;
        //optimization for big arrays
        if (startPositions.size() > 1_000) {
            List<ContainCells> startPositionsSubset = startPositions.subList(0, 20);
        ...
        while (iterator.hasNext()) {
            ContainCells startPosition = (ContainCells) iterator.next();
     ...
     * @param output         list of valid and cutted slices
     */
    public static void performStep(ObjectLogic pizza, Step step, List<ContainCells> startPositions, List<ContainCells> output) {
        ...
        ContainCells finalSlice = new ContainCells(returnedList);
     ...
     */
    public static Step selectStep(Map<ContainCells, List<Step>> steps) {
     ...
     */
    public static List<ContainCells> cutAllStartPositions(ObjectLogic pizza) {

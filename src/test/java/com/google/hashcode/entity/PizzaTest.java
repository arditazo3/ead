...
public class PizzaTest {
    ...
    private ObjectLogic examplePizza;

    @Before
    public void setup() throws IOException {
        examplePizza = new ObjectLogic(new File(EXAMPLE_INPUT_FILE_PATH), IoUtils.parseObjectLogic(EXAMPLE_INPUT_FILE_PATH), IoUtils.parseInstructions(EXAMPLE_INPUT_FILE_PATH));
    }
